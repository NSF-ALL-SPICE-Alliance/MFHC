...
# Add site specefic locations
pH_joined$site <- c(rep("kalauhaihai", nrow(df1)), rep("kalauhaihai", nrow(df2)), rep("kanewai", nrow(df3)), rep("kalauhaihai", nrow(df4)), rep("kalauhaihai", nrow(df5)))

# Select only the required columns
pH_joined <- pH_joined[, c("date_time_hst", "pH", "site")]
```

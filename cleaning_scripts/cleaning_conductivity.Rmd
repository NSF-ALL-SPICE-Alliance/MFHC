...
data_conductivity_FebApr2023_Kalauhaihai <- data_conductivity_FebApr2023_Kalauhaihai[data_conductivity_FebApr2023_Kalauhaihai$date_time > "2023-02-10 00:00:00" &    # Extract data frame subset
                   data_conductivity_FebApr2023_Kalauhaihai$date_time < "2023-04-06 00:00:00", ]


data_conductivity_FebApr2023_Kanewai <- data_conductivity_FebApr2023_Kanewai %>% 
  filter(date_time >= "2023-02-10 00:00:00" & date_time <= "2023-04-06 00:00:00")

data_conductivity_OctNov2022_Kalauhaihai <- data_conductivity_OctNov2022_Kalauhaihai %>% 
  filter(date_time >= "2022-10-06 10:10:00" & date_time <= "2022-11-10 09:30:00")

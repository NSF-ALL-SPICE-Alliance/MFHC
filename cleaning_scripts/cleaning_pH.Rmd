...
data_pH_OctNov2022_Kalauhaihai$date_time <- mdy_hms(data_pH_OctNov2022_Kalauhaihai$date_time)
```
...
data_pH_OctNov2022_Kalauhaihai <- 
  data_pH_OctNov2022_Kalauhaihai %>% 
  filter(date_time >= "2022-06-10 10:10:00" & date_time <= "2022-11-09 9:30:00")
...
data_pH_Apr2022_Kalauhaihai <-
  data_pH_Apr2022_Kalauhaihai %>% 
  filter(date_time >= "2023-04-28 15:10:00" & date_time <= "2023-05-31 09:30:00")

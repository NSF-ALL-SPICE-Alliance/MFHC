...
data_oxygen_temp_aprjuly2025_kalauhaihaigarage_21446085 <-
  data_oxygen_temp_aprjuly2025_kalauhaihaigarage_21446085 %>%
  filter(date_time_hst >= ymd_hms("2025-04-29 15:00:00", tz = "Pacific/Honolulu") & date_time_hst <= ymd_hms("2025-07-31 09:40:00", tz = "Pacific/Honolulu"))
...
data_oxygen_temp_febapr2026_kanewaispringrock_21446085 <-
  data_oxygen_temp_febapr2026_kanewaispringrock_21446085 %>%
  filter(date_time_hst >= ymd_hms("2026-02-05 13:00:00", tz = "Pacific/Honolulu") & date_time_hst <= ymd_hms("2026-04-16 10:37:00", tz = "Pacific/Honolulu"))

data_oxygen_temp_febapr2026_kalauhaihaigarage_21515403 <-
  data_oxygen_temp_febapr2026_kalauhaihaigarage_21515403 %>%
  filter(date_time_hst >= ymd_hms("2026-02-05 13:00:00", tz = "Pacific/Honolulu") & date_time_hst <= ymd_hms("2026-04-16 09:21:00", tz = "Pacific/Honolulu"))
```

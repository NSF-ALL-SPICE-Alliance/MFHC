...
data_oxygen_temp_oct2025jan2026_kalauhaihaigarage_21446085 <-
  data_oxygen_temp_oct2025jan2026_kalauhaihaigarage_21446085 %>%
  filter(date_time_hst >= ymd_hms("2025-10-28 16:55:00", tz = "Pacific/Honolulu") & date_time_hst <= ymd_hms("2026-01-22 09:27:00", tz = "Pacific/Honolulu"))

data_oxygen_temp_oct2025jan2026_kanewaispringrock_21515403 <-
  data_oxygen_temp_oct2025jan2026_kanewaispringrock_21515403 %>%
  filter(date_time_hst >= ymd_hms("2025-10-28 18:19:00", tz = "Pacific/Honolulu") & date_time_hst <= ymd_hms("2026-01-22 10:31:00", tz = "Pacific/Honolulu"))
```

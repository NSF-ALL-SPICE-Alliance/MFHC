...
data_ph_temp_oct2025jan2026_kanewaispringrock_20839036 <-
  data_ph_temp_oct2025jan2026_kanewaispringrock_20839036 %>% 
...
data_ph_temp_oct2025jan2026_kalauhaihaigarage_21873460 <-
  data_ph_temp_oct2025jan2026_kalauhaihaigarage_21873460 %>% 
  filter(date_time_hst >= ymd_hms("2025-10-10 09:40:00", tz = "Pacific/Honolulu") & date_time_hst <= ymd_hms("2026-01-22 09:27:00", tz = "Pacific/Honolulu"))
```
